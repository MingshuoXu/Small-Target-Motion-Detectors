    ...
    switch self.method
        ...
        case 'auto'
            ...
            if self.hasAutoMethod
                ...
                self.autoMethod = self.mappingAutoMethod(sprintf('%d-%d-%d', M, N, self.maxRegionSize));
                if isempty(self.autoMethod)
                    ...
                    self.mappingAutoMethod(sprintf('%d-%d-%d', M, N, self.maxRegionSize), self.autoMethod);
                end
