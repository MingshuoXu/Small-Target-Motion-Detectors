classdef ImgstreamReader < handle
    ...
    methods
        ...
        function [startImgName, endImgName] = get_filelist_from_imgsteamformat(...
            ...
            %get_filelist_from_imgsteamformat - Get start and end frame 
            %       names from image stream format.
            %   This method generates the start and end frame names based 
            %       on the specified image stream format.
            %
            %   Parameters:
            %       - self: Instance of the ImgstreamReader class.
